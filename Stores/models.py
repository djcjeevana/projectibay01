...
class Setting(models.Model):
    ...
    robot = models.CharField(blank=True,max_length=200)
    address = models.CharField(max_length=200)
    phoneone = models.IntegerField()
    phonetwo = models.IntegerField()
    ...
    @staticmethod
    def get_settings_by_id(settings_id):
       return Setting.objects.get(id=settings_id)
